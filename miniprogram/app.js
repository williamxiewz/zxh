...
// ]
//正则表达式匹配设备类型
const TYPE_PATTERN = /^[_+]BA[A-F\d]{2}$/;

App({
  onLaunch: async function () {
    console.log(util.mac2DeviceId('2B021DD25B4C'));
    if (!wx.cloud) {
    ...
    wx.onBluetoothDeviceFound((result) => {
      ...
      for (var i = 0; i < result.devices.length; i++) {
        ...
        if ((mfrHead == 'SY1' || mfrHead == 'SY2' || mac == '2B021DD25B4C') && TYPE_PATTERN.test(deviceType)) {
